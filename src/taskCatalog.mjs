export const taskCatalog = [
  {
    ...
    dataSources: ["AIRS Dust Score", "VIIRS SNPP/NOAA-20 Deep Blue", "MODIS Terra Deep Blue AOD", "MOD35 / CLDMSK"],
    modelTools: ["尺度自适应官方沙尘识别", "官方 Deep Blue 沙尘先验", "本地连续反演网络"],
  ...
  },
  {
    ...
    statusLabel: "原型可运行",
    supportedScales: ["global", "continental", "regional", "local"],
    dataSources: ["VIIRS NOAA-21/20 AOD", "MODIS Terra/Aqua AOD 3km", "OMI Aura AOD", "MOD35 / CLDMSK"],
